...
VENDORED, UNMODIFIED, from Google-Health/hear:
  python/data_processing/audio_utils.py
  https://github.com/Google-Health/hear (Apache-2.0, see LICENSE.apache-2.0)

Vendored so HeAR's mel-PCEN preprocessing (`preprocess_audio`) and the
resample/mono helper match Google's reference exactly. Do not edit; to update,
